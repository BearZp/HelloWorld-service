...
class ValidateAnswerController extends BaseController
{
    /**
    ...
    /**
     * @Route("/answer/validate", name="validateAnswer", methods={"POST"})
     *
    ...
    public function handle(Request $request): JsonResponse
    {
        ...
        try {
            $result = $this->component->validateAnswer($request->getId())->toArray();
